    ...
    return (
      <div>
        ...
        <Modal open={showForm} onClose={handleCloseForm} closeIcon>
          <Modal.Header>Create Attendance</Modal.Header>
          <Modal.Content>
            <Form>
              <Form.Field>
                <label>Title</label>
        ...
        {showSuccessMessage && (
          <Message
            success
            header="Attendance Successfully Posted"
            content="Attendance has been created successfully!"
          />
        )}
        <div>
          ...
          {loading ? (
            ...
            <Message negative>
              <Message.Header>Error loading attendances</Message.Header>
              <p>{error.message}</p>
            </Message>
          ) : (
            <Segment>
                ...
                {attendances.map((attendance) => (
                  ...
                  >
                    ...
                    <List.Content>
                      <List.Header
                        as="a"
                        href={`/courses/detail/${courseID}/attendance/detail/${attendance.id}`}
                      >
                        {attendance.title}
                      </List.Header>
                      <List.Description>
            ...
            <List divided relaxed>
              {attendances.map((attendance) => (
                <List.Item key={attendance.id}>
                  <List.Content>
                    <List.Header>{attendance.Attendance_title}</List.Header>
                    <List.Description>
                      {attendance.Attendance_created_date}
                    </List.Description>
