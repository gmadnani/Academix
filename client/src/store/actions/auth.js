...
export const getUserRole = () => {
  return (dispatch, getState) => {
    ...
    axios
      .get("https://academix-back-f296f40df966.herokuapp.com/users/profile/", {
        headers: {
...
export const authLogin = (username, password) => {
  return (dispatch) => {
    dispatch(authStart());
    axios
      .post("https://academix-back-f296f40df966.herokuapp.com/dj-rest-auth/login/", {
        username: username,
        password: password,
      })
      .then((res) => {
...
export const authSignup = (username, email, password1, password2) => {
  return (dispatch) => {
    dispatch(authStart());
    axios
      .post("https://academix-back-f296f40df966.herokuapp.com/dj-rest-auth/registration/", {
        username: username,
        email: email,
        password1: password1,
        password2: password2,
