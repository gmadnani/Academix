...
class CoursesList(models.Model):
    ...
    Syllabus_Week2 = models.CharField('week 2', max_length=30, default='week 2 session')
    Syllabus_Week3 = models.CharField('week 3', max_length=30, default='week 3 session')
    Syllabus_Week4 = models.CharField('week 4', max_length=30, default='week 4 session')
    Syllabus_Week5 = models.CharField('week 5', max_length=30, default='week 5 session')
    Syllabus_Week6 = models.CharField('week 6', max_length=30, default='week 6 session')
    Syllabus_Week7 = models.CharField('week 7', max_length=30, default='mid-term exam')
    Syllabus_Week8 = models.CharField('week 8', max_length=30, default='week 8 session')
    Syllabus_Week9 = models.CharField('week 9', max_length=30, default='week 9 session')
    Syllabus_Week10 = models.CharField('week 10', max_length=30, default='week 10 session')
    Syllabus_Week11 = models.CharField('week 11', max_length=30, default='week 11 session')
    Syllabus_Week12 = models.CharField('week 12', max_length=30, default='final exam')
